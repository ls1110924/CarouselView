 ...
 * @date 2016/9/19 1:54
 */
public class TestTwoLineEnoughAdapter extends AbsBasicCarouselAdapter<TestTwoLineEnoughAdapter.ViewHolder> {

    private static final int AMOUNT = 4;

    private final List<String> mDataSet = new ArrayList<>();

    public TestTwoLineEnoughAdapter(@NonNull Context mContext) {
        super(mContext);
